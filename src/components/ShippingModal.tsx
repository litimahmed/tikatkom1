...
export default function ShippingModal({ isOpen, onClose, lang }: ShippingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div 
        className="relative w-full max-w-lg overflow-hidden rounded-2xl bg-white shadow-2xl transition-all duration-300"
      ...
      >
        ...
        <button
          onClick={onClose}
          className={`absolute top-4 ${isRTL ? "left-4" : "right-4"} rounded-full p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-700 transition-colors`}
          aria-label="Close"
        ...
        <div className="p-6 sm:p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="font-display text-lg font-extrabold text-brand-navy sm:text-xl">
                {t.shippingTitle}
              </h3>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  {lang === "fr"
                    ? "Ne payez rien à l'avance. Payez l'agent de livraison en espèces après avoir inspecté votre produit."
          ...
          <div className="flex justify-end pt-2">
            <button
              onClick={onClose}
              className="w-full rounded-xl bg-brand-green py-3 px-4 text-sm font-bold text-white shadow-lg shadow-brand-green/20 transition-all hover:bg-brand-green-hover active:scale-95"
